...
<div class="btn-area-top"></div>
    <div class="btn-area">
        <ul>
        <li><a class="btn-action" href="javascript:;" onclick="document.form1['mode'].value='return_extract';document.form1.submit(); return false;" /><span class="btn-prev">前へ戻る</span></a></li>
        <!--{if !$err_flag}-->
