...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
    <head>
        ...
        <title>PostCarrier for EC-CUBEインストール</title>
    </head>
    <body>
        <!--{$GLOBAL_ERR}-->
        <noscript>
        ...
        <div id="outside">
            <div id="out-wrap">
                <div class="logo">
                    <img src="img/postcarrier_logo.gif" alt="PostCarrier for EC-CUBE" />
                </div>
                <div id="out-area">
                ...
                <div id="info-area">
                            <iframe src="<!--{$install_info_url}-->" width="562" height="550" frameborder="no" scrolling="no">
                                                         こちらはPostCarrier for EC-CUBEからのお知らせです。この部分は iframe対応ブラウザでご覧下さい。
                            </iframe>
                 </div>
                <!--{/if}-->
            </div>
